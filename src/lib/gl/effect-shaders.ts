...
void main() {
  vec4 c = texture(u_texture, v_uv);
  // Squircle norm, not a circle, so the falloff hugs all four edges evenly instead of pooling.
  ...
  // Same falloff either way; transparent spends it on alpha, so what sits under shows through.
