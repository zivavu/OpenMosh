<script lang="ts">
	...
	interface Props {
		 ...
		 * selected layer puts a chain in the middle of that column, and settings
		 * stranded below it read as belonging to the layer's effects.
		 */
		settings?: Snippet;
	}
