...
Version 0.9.1. Single and slideshow modes are more or less settled. The editor is the part still moving, and an update can change the shape of a saved sequence, so treat old projects there as breakable. See [CHANGELOG.md](CHANGELOG.md) for what each version changed.
